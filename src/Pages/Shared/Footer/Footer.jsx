        ...
        <footer >
            <div className="footer p-10 bg-white text-black mt-5 justify-center items-center gap-5 md:gap-20">
                <aside>
                    ...
                    <p className='font-bold' >Immigration, Refugees and Citizenship Demo Site</p>
            ...
            <p className='footer-center py-4 bg-slate-300 text-xs md:text-base'>It is a demo site for personal project</p>
        </footer>
    );
};
