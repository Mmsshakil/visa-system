...
const Profile = () => {
    ...
    return (
        <div className="hero-content gap-10 md:gap-16 lg:gap-32 flex-col lg:flex-row">
            <div className="card shrink-0 w-full max-w-lg shadow-2xl bg-base-100 rounded-lg pt-6 ">
                <figure className="w-60 h-64 mx-auto"><img className="pt-10" src={photoUrl} alt="Shoes" /></figure>
